  ...
  return (
    <div className={classes.blockInfo}>
      <div className={classes.tabs}>
        {(language == 1 || language == undefined) && <div className={active === 1 ? classes.activeTab : classes.tab} onClick={() => setAtive(1)}>
          Описание
        </div>}
        ...
        {dataText.content ? (<>
          {(language == 1 || language == undefined) && <div className={active === 2 ? classes.activeTab : classes.tab} onClick={() => setAtive(2)}>
            Содержание
          </div>}
        ...
        {dataText.author ? (<>
          {(language == 1 || language == undefined) && <div className={active === 3 ? classes.activeTab : classes.tab} onClick={() => setAtive(3)}>
            Об авторе
          </div>}
      ...
      <div className={classes.content}>
        ...
        {isClose ? (<>
          {(language == 1 || language == undefined) && <button className={classes.contentBtn} onClick={() => onClickbtn()}>Закрыть</button>}
          ...
          {(language == 1 || language == undefined) && <button className={classes.contentBtn} onClick={() => onClickbtn()}>Развернуть</button>}
