            ...
            <div className={classes.blockRegist}>
                ...
                <div className={classes.blockBtn}>
                    <Link to = '/registration-client'>
                        {(language == 1 || language == undefined) && <button className={classes.btn}>Частное лицо</button>}
                    ...
                    <Link to="/registration-organization">
                        {(language == 1 || language == undefined) && <button className={classes.btn}>Организация</button>}
                ...
                <Link to="/" className={classes.linkCancel}>
                    {(language == 1 || language == undefined) && <button className={classes.btnCancel}>Отмена</button>}
