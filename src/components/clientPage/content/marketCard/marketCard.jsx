      ...
      <div className={classes.marketCard}>
        ...
        <div className={classes.blockAct}>
          ...
          <div className={classes.blockBtn}>
            ...
            {language == 2 && <a download className={classes.toBasket} id={data.id} href={`back.qliento.com/purchase/download/${data.id}/`} >Download</a>}
            {language == 3 && <a download className={classes.toBasket} id={data.id} href={`back.qliento.com/purchase/download/${data.id}/`} >Жүктөө</a>}
