        ...
        <form className={st.form} id="formClient">
          {(language == 1 || language == undefined) && (
            <>
              ...
              ></input>
              {errors.name && <span className={st.error}>Заполните поле</span>}
              <label>Фамилия</label>
              <input
          ...
          <input
            ...
            ref={register({
              validate: (phone_number) =>
                phone_number && phone_number.length > 6,
            })}
          ></input>
          {errors.phone_number && (
            <>
              ...
              {language == 2 && (
                <span className={st.error}>Less than 6 characters</span>
              )}
              {language == 3 && (
                <span className={st.error}>6 белгиден кем</span>
              )}
            </>
          )}
          {(language == 1 || language == undefined) && (
